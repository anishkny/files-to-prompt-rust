...
#[test_case(&["tests/inputs/14_empty"], "14_empty.golden.txt"; "14_empty")]
#[test_case(&["tests/inputs/11_markdown", "--extension", "c", "--extension", "cpp"], "15_extensions.golden.txt"; "15_extensions")]
